...
| MOTP | Multiple Object Tracking Precision | $\frac{1}{\vert\text{TP}\vert} \sum_{m \in \text{TP}} \text{IoU}_m$ | Mean IoU over all true positive matches; measures localization quality independently of MOTA |
